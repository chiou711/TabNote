...
public class DragNDropCursorAdapter extends SimpleCursorAdapter implements DragNDropAdapter {
	int mPosition[];
	int mHandler;
	int mClickHandler; //cw
	int mLongClickHandler; //cw
	
	public DragNDropCursorAdapter(Context context,
			int layout,
			Cursor cursor,
			String[] from,
			int[] to,
	...
	@Override
	public int getLongClickHandler() {
		// TODO Auto-generated method stub
